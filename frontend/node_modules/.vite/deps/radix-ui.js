...
var AlertDialog = (props) => {
  ...
  return (0, import_jsx_runtime9.jsx)(Dialog, { ...dialogScope, ...alertDialogProps, modal: true });
};
...
var AlertDialogTrigger = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime9.jsx)(DialogTrigger, { ...dialogScope, ...triggerProps, ref: forwardedRef });
  }
);
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime9.jsx)(DialogPortal, { ...dialogScope, ...portalProps });
};
...
var AlertDialogOverlay = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime9.jsx)(DialogOverlay, { ...dialogScope, ...overlayProps, ref: forwardedRef });
  }
);
...
var AlertDialogContent = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime9.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: (0, import_jsx_runtime9.jsx)(
      DialogContent,
      {
        role: "alertdialog",
        ...dialogScope,
...
var AlertDialogTitle = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime9.jsx)(DialogTitle, { ...dialogScope, ...titleProps, ref: forwardedRef });
  }
);
...
var AlertDialogDescription = React8.forwardRef((props, forwardedRef) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime9.jsx)(DialogDescription, { ...dialogScope, ...descriptionProps, ref: forwardedRef });
});
...
var AlertDialogAction = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const dialogScope = useDialogScope(__scopeAlertDialog);
    return (0, import_jsx_runtime9.jsx)(DialogClose, { ...dialogScope, ...actionProps, ref: forwardedRef });
  }
);
...
var AlertDialogCancel = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime9.jsx)(DialogClose, { ...dialogScope, ...cancelProps, ref });
  }
);
...
var AvatarImage = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const loadingStatusRef = React10.useRef(imageLoadingStatus);
    useLayoutEffect2(() => {
...
function useImageCount() {
  ...
  if (true) {
    state = React10.useState(0);
    const [imageCount] = state;
    const hasWarnedRef = React10.useRef(false);
    React10.useEffect(() => {
...
var ContextMenu = (props) => {
  ...
  const hasInteractedRef = React15.useRef(false);
  if (true) {
    const hasWarnedRef = React15.useRef(false);
    React15.useEffect(() => {
  ...
  return (0, import_jsx_runtime15.jsx)(
    ContextMenuProvider,
    {
      ...
      modal,
      hasInteractedRef,
      children: (0, import_jsx_runtime15.jsx)(Root32, { ...menuScope, dir, open, onOpenChange: setOpen, modal, children })
    }
  );
};
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React24.useState(_isHydrated);
  React24.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
var OneTimePasswordField = React25.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React25.useCallback(
      (value2) => {
    ...
    const controlledValue = React25.useMemo(() => {
    ...
    const [value, setValue] = useControllableState({
      ...
      onChange: React25.useCallback(
        (value2) => onValueChange == null ? void 0 : onValueChange(value2.join("")),
        [onValueChange]
      )
    });
    const latestValueRef = React25.useRef(value);
    latestValueRef.current = value;
    const dispatch = React25.useCallback(
      (action) => {
    ...
    const validationTypeRef = React25.useRef(validation);
    React25.useEffect(() => {
      var _a3;
      if (!validation) {
        return;
    ...
    const hiddenInputRef = React25.useRef(null);
    const userActionRef = React25.useRef(null);
    ...
    const locateForm = React25.useCallback(() => {
      var _a3;
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React25.useCallback(() => {
    ...
    const valueRef = React25.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React25.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React25.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const [element, setElement] = React25.useState(null);
  ...
  const keyboardActionTimeoutRef = React25.useRef(null);
  React25.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React26.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React26.useCallback(
  ...
  const focusState = React26.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React26.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React26.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React26.useState(void 0);
...
var PasswordToggleFieldIcon = React26.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
function RadioProvider(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(RadioProviderImpl, { scope: __scopeRadio, ...context, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME11 = "RadioTrigger";
var RadioTrigger = React29.forwardRef(
...
var RadioBubbleInput = React29.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React29.useRef(checked);
    return (0, import_jsx_runtime25.jsx)(
      Primitive.input,
      {
        type: "radio",
...
var RadioGroupItemTrigger = React28.forwardRef((props, forwardedRef) => {
...
var RadioGroupItemBubbleInput = React28.forwardRef((props, forwardedRef) => {
  const { __scopeRadioGroup, ...bubbleProps } = props;
  const radioScope = useRadioScope(__scopeRadioGroup);
  return (0, import_jsx_runtime26.jsx)(RadioBubbleInput, { ...radioScope, ...bubbleProps, ref: forwardedRef });
});
...
var ScrollAreaViewport = React210.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [
      (0, import_jsx_runtime27.jsx)(ScrollAreaViewportStyle, { nonce }),
...
function SelectProvider(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime28.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime28.jsx)(Collection7.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime28.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime28.jsx)(React31.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime28.jsx)(PortalProvider4, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime28.jsx)(Portal, { asChild: true, ...portalProps }) });
};
SelectPortal.displayName = PORTAL_NAME8;
var CONTENT_NAME11 = "SelectContent";
var SelectContent = React31.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext4(CONTENT_NAME11, props.__scopeSelect);
    const { forceMount = portalContext.forceMount, ...contentProps } = props;
    ...
    return (0, import_jsx_runtime28.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime28.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime28.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
...
var SelectContentFragment = React31.forwardRef((props, forwardedRef) => {
  ...
  return ReactDOM2.createPortal(
    (0, import_jsx_runtime28.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime28.jsx)(Collection7.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime28.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectArrow = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime28.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime28.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime28.jsx)("option", { value: "" }) : null,
...
var Slider = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React33.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction4(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React33.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime30.jsx)(Collection8.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime30.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime30.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index, isFormControl: isFormControl2 }) => (0, import_jsx_runtime30.jsxs)(import_jsx_runtime30.Fragment, { children: [
...
function SwitchProvider(props) {
  ...
  return (0, import_jsx_runtime31.jsx)(SwitchProviderImpl, { scope: __scopeSwitch, ...context, children: isFunction5(internal_do_not_use_render) ? internal_do_not_use_render(context) : children });
}
var TRIGGER_NAME13 = "SwitchTrigger";
var SwitchTrigger = React34.forwardRef(
...
var SwitchBubbleInput = React34.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React34.useRef(checked);
    return (0, import_jsx_runtime31.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime33.jsx)(Portal, { asChild: true, container: context.announcerContainer || void 0, children: (0, import_jsx_runtime33.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime33.jsxs)(import_jsx_runtime33.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToggleGroup = React38.forwardRef((props, forwardedRef) => {
  const { type, ...toggleGroupProps } = props;
  if (type === "single") {
    const singleProps = toggleGroupProps;
    return (0, import_jsx_runtime35.jsx)(ToggleGroupImplSingle, { role: "radiogroup", ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime35.jsx)(ToggleGroupImplMultiple, { role: "toolbar", ...multipleProps, ref: forwardedRef });
  }
  throw new Error(`Missing prop \`type\` expected on \`${TOGGLE_GROUP_NAME}\``);
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
var [ToggleGroupValueProvider, useToggleGroupValueContext] = createToggleGroupContext(TOGGLE_GROUP_NAME);
var ToggleGroupImplSingle = React38.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime35.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      onItemDeactivate: React38.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime35.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React38.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React38.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React38.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime35.jsx)(
...
var ToggleGroupImpl = React38.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
...
var ToggleGroupItem = React38.forwardRef(
  (props, forwardedRef) => {
...
var ToggleGroupItemImpl = React38.forwardRef(
  (props, forwardedRef) => {
...
var ToolbarToggleItem = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime36.jsx)(ToggleGroupItem, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
